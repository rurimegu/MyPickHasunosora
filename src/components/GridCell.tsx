    ...
    >
      {song ? (
        <div className="w-full h-full absolute inset-0 flex flex-col">
          ...
          <div 
            className="absolute inset-x-0 bottom-0 pt-6 md:pt-10 pb-1.5 md:pb-2.5 px-1 md:px-2 flex flex-col justify-end pointer-events-none z-0"
        ...
        <div className="flex flex-col items-center gap-1 md:gap-2 text-slate-400 group-hover:text-pink-500 transition-colors duration-300 p-1.5 sm:p-3">
          ...
          <span className="text-[7px] md:text-[10px] tracking-wider font-semibold uppercase text-center">Pick Song</span>
        </div>
      )}
    </div>
  );
